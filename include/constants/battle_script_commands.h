...
#define VARIOUS_ACTIVATE_WEATHER_CHANGE_INNATE1      141
#define VARIOUS_ACTIVATE_WEATHER_CHANGE_INNATE2      142
#define VARIOUS_ACTIVATE_WEATHER_CHANGE_INNATE3      143
#define VARIOUS_ACTIVATE_TERRAIN_CHANGE_ABILITIES    144
#define VARIOUS_ACTIVATE_TERRAIN_CHANGE_INNATE1      145
#define VARIOUS_ACTIVATE_TERRAIN_CHANGE_INNATE2      146
#define VARIOUS_ACTIVATE_TERRAIN_CHANGE_INNATE3      147
...
enum MoveEndEffects
{
    ...
    MOVEEND_INNATE1_ATTACKER,
    MOVEEND_INNATE2_ATTACKER,
    MOVEEND_INNATE3_ATTACKER,
